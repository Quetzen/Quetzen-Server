...
<tileset version="1.8" tiledversion="1.8.2" name="Cyberworld new screens" tilewidth="32" tileheight="40" tilecount="16" columns="8" objectalignment="bottom">
 <tileoffset x="0" y="40"/>
 <image source="Cyberworld new screens.png" width="256" height="80"/>
 <tile id="0">
  <animation>
